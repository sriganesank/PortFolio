        ...
        {experiences.map((exp, index) => (
          ...
          >
            ...
            <motion.div
              ...
              whileHover={{ scale: 1 }}
            >
              <h3 className="text-lg sm:text-xl md:text-lg lg:text-2xl font-semibold text-white">{exp.role}</h3>
              <p className="text-yellow-400 text-base sm:text-lg md:text-base lg:text-xl">{exp.company}</p>
              <p className="text-gray-400 text-sm sm:text-base md:text-sm lg:text-lg mt-2">{exp.year}</p>
              <p className="text-gray-300 mt-4 text-sm sm:text-base md:text-sm lg:text-lg">{exp.description}</p>
            </motion.div>
          </motion.div>
        ))}
      </div>
